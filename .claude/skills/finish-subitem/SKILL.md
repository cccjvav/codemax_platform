...
git push origin arena/01a08bf5-codemax-platform
git rev-parse HEAD
...
```bash
gh run list --branch arena/01a08bf5-codemax-platform --limit 20 --json databaseId,headSha,status,conclusion,url
```
