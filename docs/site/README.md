...
不需要装 `requirements.txt` 里那 22 个依赖**，只要有 Python 和 `mistune`。
...
> **预期输出**：`模块 72 个 · 依赖边 179 条 · 路由 32 条 · 符号 250+ 个 · 文档 21 份`
>
> （模块/依赖边/路由数只随**代码**变，可以当断言用；文档行数会随文档增改而变，不必对齐。）
