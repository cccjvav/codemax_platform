...
本机实测：**654 passed, 4 skipped**（SQLite 后端，658 collected）；真 PostgreSQL 16 上 **626 passed, 2 skipped**（依赖大升级后那次实测，早于本轮新增用例）。
...
# ⑥ 全量跑一遍
python -m pytest -q
# 本机实测：654 passed, 4 skipped（658 collected，SQLite）
