...
> `database init/README.md`（建表脚本）、`app/templates/README.md`（前端模板）、`app/static/README.md`、`.github/workflows/README.md`、`docs/ROOT_FILES.md`、`tests/README.md`。本文所有 `L12-L35` 形式的引用都对应这个提交。
