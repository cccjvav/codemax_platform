...
| --- | --- | --- |
| [`scripts/build_docs_site.py`](build_docs_site.py) | `9b137a3204f7` | L1–L1063 |
| [`scripts/check_docs_contract.py`](check_docs_contract.py) | `2cf72c0d91d0` | L1–L154 |
| [`scripts/check_schema_pg.mjs`](check_schema_pg.mjs) | `eb38dfc1e69d` | L1–L70 |
...
第九批仍沿用现有构建/README门禁：新报告登记DOC_GROUPS，新增服务/迁移/测试补分段解释后再更新SHA；不只刷新指纹。
...
第十二批报告已登记build_docs_site.DOC_GROUPS；路由多一个本地核验控制，构建与运行时路由数须由测试共同核对，不手改生成JSON。
